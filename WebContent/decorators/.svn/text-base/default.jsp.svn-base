...
<table style="width: 100%">
		...
		<td style="vertical-align: top; padding: 0;">
			...
			<div style="padding: 3px 6px; background-color: rgb(240, 240, 240);">
				<div style="float: right;">
					<%-- <iita:authorize ifAnyGranted="ROLE_ADMIN"><s:include value="/WEB-INF/jsp/admin/fast-switch.jsp" /></iita:authorize> --%>
					Search: <form method="get" action="<s:url action='search' />"><input name="q" style="width: 200px;" value="" /> <input type="submit" value="Search" /></form>
				</div>
	...
	<tr>
		<td style="vertical-align: bottom; padding: 5px 0 0 0;">
			<div style="margin: 1pt 0px 6px 0px;"><jsp:include page="/common/menu.jsp" /></div>
		</td>
	</tr>
</table>
</div>
...
Event.observe(window, "load", function() {
	...
	IITAHELP = new IITA.Help("<c:url value="/" />help/content/");
});
</script>
</body>
</html>
