...
<table class="data-listing">
	...
	<tbody id="accession-tabular">
		<s:iterator value="top">
			<tr class="<s:if test="[1].isSelected(top)">accession-selected</s:if>">
				<td><a href="<c:url value="/accession" />/<s:property value="name" />"><s:property value="name" /></a></td>
				<td>
				<div class="select-tool"><a x:id="<s:property value="id" />" class="btn_select" href="#">Add to list</a></div>
				<div class="unselect-tool"><a x:id="<s:property value="id" />" class="btn_unselect" href="#">Remove from list</a></div>
				</td>
