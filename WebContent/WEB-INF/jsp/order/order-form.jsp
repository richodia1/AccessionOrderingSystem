...
<s:form action="order!update" method="post">	
	...
	<table class="inputform">
		...
		<tr>
			...
			<td><s:textfield readonly="true" name="order.requestor.lastName" value="%{surname}" /></td>
		</tr>
		<tr>
			<td>First name:</td>
			<td><s:textfield readonly="true" name="order.requestor.firstName" value="%{firstname}" /></td>
		</tr>
		<tr>
			<td class="input-required">E-Mail address:</td>
			<td><s:textfield readonly="true" name="order.requestor.email" value="%{email}" />
		...
		<tr>
			...
			<td><s:textfield readonly="true" name="order.requestor.organization" value="%{requestorOrg}" /></td>
		</tr>
		<tr>
			<td class="input-required">Organization type:</td>
			<td><s:select name="order.organizationType" value="%{requestorOrgType}" list="{'CGIAR Centre','Commercial company','Farmer','Genebank','National agric. research (NARS)','Non-governmental organization (NGO)','Regional organization','University','Individual other than farmers'}" /></td>
		</tr>
		<tr>
			<td class="input-required">Shipping address:</td>
			<td><s:textarea readonly="true" name="order.requestor.address" value="%{requestorAddress}" /></td>
		</tr>
		<tr>
			<td>Postal code:</td>
			<td><s:textfield name="order.requestor.postalCode" value="%{requestorPostalCode}" /></td>
		</tr>
		<tr>
			<td>City:</td>
			<td><s:textfield name="order.requestor.city" value="%{requestorCity}" /></td>
		</tr>
		<tr>
			<td class="input-required">Country:</td>
			<td><s:textfield readonly="true" name="order.requestor.country" value="%{requestorCountry}" /></td>
		</tr>
	</table>
