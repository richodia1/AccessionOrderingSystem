...
public class BrowseAction extends AccessionListAction implements DownloadableStream {
	private static final int maxResults = 50;

	private int startAt = 0;
	private PagedResult<Accession> paged;
	 ...
	 * 
	 */
	public BrowseAction(AccessionService accessionService, ExperimentService experimentService, SelectionService selectionService, FilterService filterService, SingerExportService singerService) {
	...
	public String execute() {
		this.paged = this.accessionService.list(this.filterService.getCurrentFilters(), this.startAt, maxResults);
