...
<s:if test='%{user.authenticationType.toString()=="PASSWORD"}'>
	...
	<p><br/><br/><b>Change your current PASSWORD to login to this application.</b></p>
...
<div id="actionMessages">Always check your mailbox when you have requested Custom generated password from this system to pick up your new password.</div>
